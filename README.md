...
| **AiPy (AiPy Pro)** | A general-purpose AI assistant for beginners, highly compatible with the DeepSeek model, applicable to scenarios such as programming development and data analysis.| [Guide](./docs/aipy.md) |
